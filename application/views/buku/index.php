...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <?php } ?>
            <?= $this->session->flashdata('pesan'); ?>
            <button type="button" class="btn btn-primary mb-3" data-toggle="modal" data-target="#bukuBaruModal">
                Buku Baru
            </button>
                        ...
                        <tr>
                            ...
                            <td>
                                <picture>
                                    ...
                                    <img src="<?= base_url('assets/startboostrap/img/upload/') . $b['image']; ?>" class="img-fluid img-thumbnail" alt="...">
                                </picture>
                            </td>
                            <td>
                                <a href="<?=
